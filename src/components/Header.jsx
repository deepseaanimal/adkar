...
export default function Header() {
  ...
  const { page, params, syncConfig } = state;
  ...
  const isSyncConfigured = syncConfig.token && syncConfig.gistId;
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">{isSyncConfigured ? 'Synced' : 'Sync'}</span>
            </button>
          </div>
        </div>
      </header>
